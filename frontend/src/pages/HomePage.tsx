  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <section className="relative flex flex-col items-center justify-center overflow-hidden py-20 md:py-32">
        <div className="absolute inset-0 -z-10 bg-gradient-to-b from-sky-50 to-white dark:from-slate-900 dark:to-slate-800"></div>
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mx-auto mb-8 max-w-2xl text-xl text-slate-600 dark:text-slate-300 md:text-2xl">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="card transition-transform hover:scale-105">
              ...
              <h3 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">Secure & Decentralized</h3>
            ...
            {/* Feature 2 */}
            <div className="card transition-transform hover:scale-105">
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-violet-100 dark:bg-violet-900">
              ...
              <h3 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">Custom Stablecoins</h3>
              <p className="text-slate-600 dark:text-slate-300">
            ...
            <div className="card transition-transform hover:scale-105">
              ...
              <h3 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">Earn Rewards</h3>
              <p className="text-slate-600 dark:text-slate-300">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mx-auto max-w-4xl">
            <div className="relative">
              {/* Timeline line */}
              <div className="absolute left-4 top-0 h-full w-0.5 bg-sky-200 dark:bg-sky-900 md:left-1/2 md:-ml-0.5"></div>
                ...
                <div className="flex md:flex-row-reverse md:items-center">
                  <div className="ml-8 md:ml-0 md:mr-8 md:w-1/2">
                    <div className="rounded-lg bg-white p-6 shadow-md dark:bg-slate-800">
                      <h3 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">1. Connect Your Wallet</h3>
                      <p className="text-slate-600 dark:text-slate-300">
                        Connect your Solana wallet to access the STABLE-FUNDS platform and all its features.
                      </p>
                    </div>
                  </div>
                  <div className="absolute left-0 top-0 flex h-8 w-8 items-center justify-center rounded-full bg-sky-500 text-white md:left-1/2 md:-ml-4">
                    <span>1</span>
                  </div>
                </div>
              </div>
              ...
              <div className="relative mb-8 pt-16 md:mb-0">
                <div className="flex md:items-center">
                  <div className="ml-8 md:ml-8 md:w-1/2">
                    <div className="rounded-lg bg-white p-6 shadow-md dark:bg-slate-800">
                      <h3 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">2. Deposit Collateral</h3>
                      <p className="text-slate-600 dark:text-slate-300">
                        Deposit JitoSOL or Stablebonds as collateral to back your stablecoins.
                      </p>
                    </div>
                  </div>
                  <div className="absolute left-0 top-16 flex h-8 w-8 items-center justify-center rounded-full bg-sky-500 text-white md:left-1/2 md:-ml-4">
                    <span>2</span>
                  </div>
                </div>
              </div>
              ...
              <div className="relative mb-8 pt-16 md:mb-0">
                <div className="flex md:flex-row-reverse md:items-center">
                  <div className="ml-8 md:ml-0 md:mr-8 md:w-1/2">
                    <div className="rounded-lg bg-white p-6 shadow-md dark:bg-slate-800">
                      <h3 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">3. Create Stablecoins</h3>
                      <p className="text-slate-600 dark:text-slate-300">
              ...
              <div className="relative pt-16">
                <div className="flex md:items-center">
                  <div className="ml-8 md:ml-8 md:w-1/2">
                    <div className="rounded-lg bg-white p-6 shadow-md dark:bg-slate-800">
                      <h3 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">4. Earn & Govern</h3>
                      <p className="text-slate-600 dark:text-slate-300">
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          <div className="mx-auto max-w-3xl space-y-4">
            <div className="card">
              <h3 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">What is STABLE-FUNDS?</h3>
              <p className="text-slate-600 dark:text-slate-300">
            ...
            <div className="card">
              <h3 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">How are stablecoins collateralized?</h3>
              <p className="text-slate-600 dark:text-slate-300">
            ...
            <div className="card">
              <h3 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">What is Jito Restaking?</h3>
              <p className="text-slate-600 dark:text-slate-300">
            ...
            <div className="card">
              <h3 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">How can I participate in governance?</h3>
              <p className="text-slate-600 dark:text-slate-300">
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-r from-sky-500 to-violet-500 py-16 text-white md:py-24">
        <div className="container mx-auto px-4 text-center">
          ...
          <button
            onClick={handleGetStarted}
            className="btn bg-white px-8 py-3 text-base font-medium text-sky-600 hover:bg-slate-100"
          >
            Launch App
          </button>
        </div>
      ...
      <footer className="bg-slate-900 py-12 text-slate-300">
        <div className="container mx-auto px-4">
          <div className="grid gap-8 md:grid-cols-4">
            <div>
              <h3 className="mb-4 text-xl font-bold text-white">STABLE-FUNDS</h3>
              <p className="mb-4">
